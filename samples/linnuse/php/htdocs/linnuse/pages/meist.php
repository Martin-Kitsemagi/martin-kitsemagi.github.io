...
<head>
    ...
    <link href="css/staff_large.css" rel="stylesheet" type="text/css">
...
<body>
    <div class="page_wrapper page_subpage">
        ...
        <div class="page_inner_wrapper">
           ...
           <?php include_once(__DIR__ . "/../../../htdocs_includes/linnuse/panels/staff_large.php"); ?>
        </div>
