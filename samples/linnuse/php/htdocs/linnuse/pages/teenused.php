...
<head>
    ...
    <link href="css/services_large.css" rel="stylesheet" type="text/css">
    ...
    <script src="js/services_large.js" defer></script>
</head>
<body>
    <div class="page_wrapper page_subpage_header">
        <?php include_once(__DIR__ . "/../../../htdocs_includes/linnuse/panels/nav.php"); ?>

        <div class="page_inner_wrapper">
           <?php include_once(__DIR__ . "/../../../htdocs_includes/linnuse/panels/services_large.php"); ?>
        </div>
